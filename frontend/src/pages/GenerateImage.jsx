      ...
      <div className='max-w-7xl mx-auto space-y-6'>
        ...
        <div className='grid grid-cols-1 xl:grid-cols-[420px_1fr] gap-6'>
          <form className='bg-white rounded-3xl border border-gray-200 p-6 shadow-sm'>
            ...
            <p className='text-sm text-gray-500 mb-6'>Describe the image you want to generate.</p>
          ...
          <section className='bg-white rounded-3xl border border-gray-200 p-6 shadow-sm min-h-320px'>
            ...
            <div className='rounded-3xl border border-dashed border-gray-300 bg-gray-50 p-5 text-gray-600 min-h-220px flex items-center justify-center'>
              <div className='flex flex-col items-center gap-4'>
                <div className='w-full max-w-full rounded-3xl bg-gray-200 aspect-4/3 flex items-center justify-center'>
                  <span className='text-gray-500'>Image preview will appear here</span>
                </div>
                <p className='text-sm text-gray-500'>Your generated image will display in this panel after submission.</p>
              </div>
            </div>
          </section>
        </div>
